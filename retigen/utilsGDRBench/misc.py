...
ALL_DATASETS=['APTOS','DEEPDR','FGADR','IDRID','MESSIDOR','RLDR','DRTiD_1view','DRTiD_2views','MFIDDR_1view','MFIDDR_4views']
ESDG_DATASETS = ['APTOS','DEEPDR','FGADR','IDRID','MESSIDOR','RLDR','DDR','EYEPACS','DRTiD_1view','DRTiD_2views','MFIDDR_1view','MFIDDR_4views']
ALL_METHODS = ['GDRNet', 'GDRNet25', 'GDRNet50', 'GDRNet75', 'ERM', 'GREEN', 'CABNet', 'MixupNet', 'MixStyleNet', 'Fishr', 'DRGen','FishrDSU','FishrAUG','FishrDSUAUG','FishrCONAUG','FishrCONAUG1','FishrCONAUG2','FishrCONAUG3']
