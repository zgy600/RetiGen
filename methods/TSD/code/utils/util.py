...
def img_param_init(args):
    ...
    elif dataset == 'Retigen':
        domains = ["APTOS", "DEEPDR", "DRTiD_1view", "IDRID", "MFIDDR_4viewss", "RLDR"]
    ...
    args.img_dataset = {
        ...
        'Retigen':  ["APTOS", "DEEPDR", "DRTiD_1view", "IDRID", "MFIDDR_4viewss", "RLDR"],
